...
const PostCard = ({ title, content, slug, featuredImage }) => {
  ...
  return (
    <Container>
      <div className='w-full p-4 my-4 rounded-lg border border-gray-300 bg-[#f5fdf9] shadow-sm'>
        <div className="flex gap-4 items-start flex-col lg:flex-row">
          <div className="w-full h-32 md:w-40 md:h-40 shrink-0">
            {imgSrc ? (
              <img
                src={imgSrc}
          ...
          <div className="flex-1 flex flex-col">
            <h2 className='text-xl text-[#1f1e1e] font-black font-mono line-clamp-2'>{title}</h2>
